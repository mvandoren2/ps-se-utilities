...
CREATE TABLE `guacamole_db.guacamole_connection_group` (
...
CREATE TABLE `guacamole_db.guacamole_connection` (
...
CREATE TABLE `guacamole_db.guacamole_entity` (
...
CREATE TABLE `guacamole_db.guacamole_user` (
...
CREATE TABLE `guacamole_db.guacamole_user_group` (
...
CREATE TABLE `guacamole_db.guacamole_user_group_member` (
...
CREATE TABLE guacamole_db.guacamole_sharing_profile (
...
CREATE TABLE `guacamole_db.guacamole_connection_parameter` (
...
CREATE TABLE guacamole_db.guacamole_sharing_profile_parameter (
...
CREATE TABLE guacamole_db.guacamole_user_attribute (
...
CREATE TABLE guacamole_db.guacamole_user_group_attribute (
...
CREATE TABLE guacamole_db.guacamole_connection_attribute (
...
CREATE TABLE guacamole_db.guacamole_connection_group_attribute (
...
CREATE TABLE guacamole_db.guacamole_sharing_profile_attribute (
...
CREATE TABLE `guacamole_db.guacamole_connection_permission` (
...
CREATE TABLE `guacamole_db.guacamole_connection_group_permission` (
...
CREATE TABLE guacamole_db.guacamole_sharing_profile_permission (
...
CREATE TABLE `guacamole_db.guacamole_system_permission` (
...
CREATE TABLE `guacamole_db.guacamole_user_permission` (
...
CREATE TABLE `guacamole_db.guacamole_user_group_permission` (
...
CREATE TABLE `guacamole_db.guacamole_connection_history` (
...
CREATE TABLE guacamole_db.guacamole_user_history (
...
CREATE TABLE guacamole_db.guacamole_user_password_history (
